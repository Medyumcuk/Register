...
client.on("ready", () => {//splashen
  client.user.setPresence({
    game: { name: ` Batu <3 Ayris `, type: "WATCHING" },
    status: "online"
  });
});
...
// GİRİŞ 
 ...
 member.roles.add(rol)//splashen
  ...
  var kontrol;
if (tarih < 1296000000) kontrol = '<a:vnt_emoji_2:784852585156050967> Bu Kullanıcı **Şüpheli**'
if (tarih > 1296000000) kontrol = '<a:vnt_emoji_2:784852512833929216> Bu Kullanıcı **Güvenli**'
  moment.locale("tr");
  let kanal1 = client.channels.cache.find(x => x.id === kanal);
    let giris = new Discord.MessageEmbed()
    .setDescription(`
●▬▬▬▬▬▬▬▬ <a:vnt_emoji_2:784853553419517982> **Bir Üye Katıldı** <a:vnt_emoji_2:784853553419517982> ▬▬▬▬▬▬▬▬●

• <a:vnt_emoji_2:784852682946641950> Hoşgeldin ${member}

• <a:vnt_emoji_2:784854051417227284> Seninle birlikte **${member.guild.memberCount}** kişiyiz.

• [ **${ayarlar.tag}** ] Tagımızı alarak ekibimize katılabilirsin.

• <a:vnt_emoji_20:784856423686340608> <@&${ayarlar.yetkiliROL}> rolündekiler seninle ilgilenicektir.

• <<a:vnt_emoji_2:784862301048143933> Hesabın Oluşturulma Tarihi: \n • \` ${moment(member.user.createdAt).format("YYYY DD MMMM dddd (hh:mm:ss)")} \`

•  ${kontrol} 

• <a:vnt_emoji_2:784854720119570493> Ses teyit odasında kaydınızı yaptırabilirsiniz. 
